...
export const QuestionEditor: React.FC<QuestionEditorProps> = ({ 
  question, index, mondaiList, onChange, onRemove, onNext, isLastQuestion, level 
}) => {
  ...
  const handleFileSelect = (field: keyof QuestionType, file: File | undefined | null) => {
    if (file) {
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        >
          ...
          <input 
            ...
            ref={audioInputRef} 
            onChange={e => {
              handleFileSelect('audio_clip_url', e.target.files?.[0]);
              e.target.value = '';
            }} 
          />
        </div>
        ...
        >
          ...
          <input 
            ...
            ref={imageInputRef} 
            onChange={e => {
              handleFileSelect('image_url', e.target.files?.[0]);
              e.target.value = '';
            }} 
          />
        </div>
