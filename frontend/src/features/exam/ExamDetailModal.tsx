...
import {
  X, Headphones, Check, Clock, BookOpen, Layers, Play, Pause, Loader2
} from 'lucide-react'
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-slate-100 dark:border-slate-700 shrink-0 flex justify-end">
          <button
            onClick={onClose}
