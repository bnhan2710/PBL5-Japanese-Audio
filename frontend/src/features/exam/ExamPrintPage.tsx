...
export default function ExamPrintPage() {
 ...
 <p className="mt-3 text-sm leading-6 text-muted-foreground">{error || 'Dữ liệu đề thi không hợp lệ'}</p>
 <button
 ...
 <p className="mt-1 text-sm text-muted-foreground">Trang này được tối ưu để dùng tính năng Save as PDF của trình duyệt.</p>
 ...
 <p className="mt-2 text-sm leading-6 text-muted-foreground">Mỗi câu hỏi được thiết kế cho kỹ năng nghe hiểu tiếng Nhật theo từng phần mondai.</p>
 </div>
 <div className="rounded-2xl border border-border bg-card p-4">
 <p className="text-sm font-semibold text-stone-900">2. Chọn một đáp án đúng nhất</p>
 <p className="mt-2 text-sm leading-6 text-muted-foreground">Đề in ra giữ khoảng trắng hợp lý để người làm bài dễ đọc và ghi chú trực tiếp.</p>
 </div>
 <div className="rounded-2xl border border-border bg-card p-4">
 <p className="text-sm font-semibold text-stone-900">3. Đối chiếu đáp án ở cuối file</p>
 <p className="mt-2 text-sm leading-6 text-muted-foreground">Phần đáp án được tách riêng giúp dùng chung cho cả bản thi và bản chấm.</p>
 </div>
 </div>
 </section>
