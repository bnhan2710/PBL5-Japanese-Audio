      ...
      <section className="rounded-[32px] border border-blue-100 bg-gradient-to-br from-white via-sky-50 to-blue-50 p-8 shadow-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="grid min-w-[300px] gap-3 sm:grid-cols-3 lg:w-[380px] lg:grid-cols-1">
            <div className="rounded-2xl border border-white/70 bg-white/90 px-4 py-4 shadow-sm">
              <div className="mb-1 flex items-center gap-2 text-slate-500">
                <Clock3 className="h-4 w-4" />
                <span className="text-xs font-semibold uppercase tracking-[0.18em]">Thời lượng</span>
              </div>
              <p className="text-xl font-bold text-slate-900">{formatDuration(exam.time_limit)}</p>
            </div>
            <div className="rounded-2xl border border-white/70 bg-white/90 px-4 py-4 shadow-sm">
              <div className="mb-1 flex items-center gap-2 text-slate-500">
              ...
              <p className="text-xl font-bold text-slate-900">{exam.total_questions} câu</p>
            </div>
            <div className="rounded-2xl border border-white/70 bg-white/90 px-4 py-4 shadow-sm">
              <div className="mb-1 flex items-center gap-2 text-slate-500">
              ...
              <p className="text-xl font-bold text-slate-900">{exam.mondai_groups.length} nhóm</p>
            </div>
          </div>
        </div>
      </section>
