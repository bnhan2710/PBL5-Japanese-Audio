...
import { ArrowLeft, BookOpen, Clock3, Layers3, Loader2, PlayCircle } from 'lucide-react'
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
              {exam.description ||
                'Đề thi nghe gồm nhiều mondai, được trình bày theo cấu trúc JLPT để người dùng luyện tập trực tiếp trên giao diện web.'}
            </p>
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                ...
                >
                  ...
                  <p className="mt-1 text-xs opacity-80">
                    Không có nút điều khiển âm thanh khi thi.
                  </p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="mt-1 text-xs opacity-80">
                    Có thể phát, tua, chỉnh tốc độ và âm lượng.
                  </p>
                </button>
              </div>
            </div>
