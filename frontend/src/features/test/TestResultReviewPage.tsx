...
export default function TestResultReviewPage() {
 ...
 // Audio simulation logic (Optional - we could just not play auto audio in Review mode)
 // We'll let users interact and play audio manually in review mode to focus on reading text.
 ...
 <div className="justify-self-start lg:justify-self-end hidden lg:block">
 ...
 // Logic for Answer Card Highlighting:
 // 1. If Correct AND Selected: Emerald Box (Perfect)
 // 2. If Correct BUT Not Selected: Blue/Green subtle hint (This was the right answer)
 // 3. If Incorrect AND Selected: Rose Box (Mistake)
 // 4. Default: Neutral Box
