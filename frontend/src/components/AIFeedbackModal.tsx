...
export const AIFeedbackModal: React.FC<AIFeedbackModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md overflow-hidden bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 dark:border-white/10 shrink-0">
        ...
        {isSuccess ? (
          <div className="p-8 text-center animate-in zoom-in-95 duration-300">
            ...
            <p className="text-slate-500 dark:text-slate-400">Đánh giá của bạn đã được ghi nhận và sẽ giúp chúng tôi cải thiện hệ thống.</p>
          </div>
        ) : (
